<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from mannatthemes.com/frogetor/vertical/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 May 2019 03:20:12 GMT -->
                ...
                <div class="card-body">
                            ...
                            <div class="form-group"><label for="username">Email</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i
                                                class="mdi mdi-account-outline font-16"></i></span></div><input name="email"
                                        type="email" class="form-control" id="username" placeholder="Enter Email">
                                </div>
                            </div>
                            <div class="form-group"><label for="userpassword">Password</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend"><span class="input-group-text" id="basic-addon2"><i
                                                class="mdi mdi-key font-16"></i></span></div><input type="password" name="password"
                    ...
                    <div class="account-social text-center">
                        ...
                        <ul class="list-inline mb-4">
                            ...
                            <li class="list-inline-item"><a href="{{ url('google') }}" class=""><i class="fab fa-google google"></i></a>
                            </li>
                        </ul>
                    </div>
                    <div class="m-3 text-center bg-light p-3 text-primary">
                        <h5 class="">Don't have an account ?</h5>
                        <p class="font-13">Join <span>Frogetor</span> Now</p><a href="/register"
                            class="btn btn-primary btn-round waves-effect waves-light">Resister</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from mannatthemes.com/frogetor/vertical/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 May 2019 03:20:13 GMT -->
